...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/rhdh-JslYoon-org/chatbot-github-test671, stored in [quay.io/rh-ee-lyoon-dh/chatbot-github-test671](https://quay.io/rh-ee-lyoon-dh/chatbot-github-test671) and deployed through ArgoCD. 
